...
ROOT_DIR=$(pwd)
TRAIN_FILE=$ROOT_DIR/data/gsm8k/train.parquet
GSM8K_VAL_PATH=$ROOT_DIR/data/gsm8k/test_100.parquet
...
VAL_FILE_LIST="['$MATH500_100_PATH']"


LR=1e-6
BACKBONE="R1-Distill-Qwen-1.5B"
BACKBONE_PATH="/code/models/R1-Distill-Qwen-1.5B"
